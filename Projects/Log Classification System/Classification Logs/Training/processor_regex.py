...
if __name__ == "__main__":
    ...
    print(classify_with_regex("File file2.txt uploaded successfully by user user1."))
    print(classify_with_regex("Disk cleanup completed successfully."))
    print(classify_with_regex("System reboot initiated by user3."))
    print(classify_with_regex("HELLO MATE!."))
    print(classify_with_regex("YOOOO."))